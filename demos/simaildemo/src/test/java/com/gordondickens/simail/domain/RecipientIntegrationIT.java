...
@Transactional
public class RecipientIntegrationIT {
    ...
    public void testCountAllRecipients() {
        ...
        long count = recipientService.countAllRecipients();
    ...
    public void testFindRecipient() {
        ...
        obj = recipientService.findRecipient(id);
    ...
    public void testFindRecipientEntries() {
        ...
        List<Recipient> result = recipientService.findRecipientEntries(firstResult, maxResults);
    ...
    public void testUpdateRecipientUpdate() {
        ...
        boolean modified = dod.modifyRecipient(obj);
        Integer currentVersion = obj.getVersion();
        Recipient merged = recipientService.updateRecipient(obj);
        recipientRepository.flush();
    ...
    public void testDeleteRecipient() {
        ...
        Assert.assertNotNull("Data on demand for 'Recipient' failed to provide an identifier", id);
        obj = recipientService.findRecipient(id);
        recipientService.deleteRecipient(obj);
        recipientRepository.flush();
        Assert.assertNull("Failed to remove 'Recipient' with identifier '" + id + "'", recipientService.findRecipient(id));
    }
}
